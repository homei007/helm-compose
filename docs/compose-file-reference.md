...
| needs            | array  | Release names that must complete successfully before this release is installed or upgraded.                                                                                | false    |                | 1.1        |
...
| postRenderer       | string | Helm 3 path or executable name for a post-renderer.                                                                                                                        | false    |                | 1.0        |
| postRendererPlugin | string | Name of an installed Helm 4 postrenderer plugin. Use this instead of `postRenderer` when running Helm 4.                                                               | false    |                | 1.4        |
| postRendererArgs   | array  | Arguments passed to the post-renderer (can specify multiple).                                                                                                             | false    |                | 1.0        |
